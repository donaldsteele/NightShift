...
/// <summary>
/// Resolves every file and directory ClaudePilot owns, rooted at a single app-data directory.
/// Layout is fixed by the implementation plan §8:
/// <code>
/// ClaudePilot/
/// ├─ settings.json
/// ├─ state.json
/// ├─ logs/claudepilot-.log
/// └─ runs/
///    ├─ index.jsonl
///    └─ &lt;runId&gt;.log
/// </code>
...
public sealed class AppPaths
{
    ...
    public const string AppFolderName = "ClaudePilot";
    ...
    /// <summary>
    /// The default location: <c>%APPDATA%\ClaudePilot</c> on Windows, the XDG/`~/.config`
    ...
    /// produces <c>claudepilot-20260726.log</c>.
    /// </summary>
    public string LogFileTemplate => Path.Combine(LogsDirectory, "claudepilot-.log");
